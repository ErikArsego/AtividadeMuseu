...
public class Sistema {
    ...
    private static void cadastrarObraDeArte() {
        ...
        System.out.print("Digite o seu ano de criação: ");
        ...
        try {
            ...
            System.out.println("Sucesso! Obra de arte cadastrada");
        } catch (IOException e) {
            System.out.println(e.getMessage());
        }
    }
    ...
    private static void buscarObraDeArte() {
        System.out.print("Digite o nome da obra a ser buscada: ");
        String titulo = Console.lerString();

        try {
            ObrasDeArte obra = GerenciadorObrasDeArte.buscarObra(titulo);
            System.out.println("Obra encontrada" + obra.toString() + "\n");
        } catch (Exception e) {
            System.out.println(e.getMessage());
        }
    }
    ...
    private static void atualizarObraDeArte() throws Exception {
        ...
        System.out.print("Digite o nome da obra a ser atualizada: ");
        String titulo = Console.lerString();
        ObrasDeArte obra = GerenciadorObrasDeArte.buscarObra(titulo);
        if (obra != null) {
            ...
            System.out.print("Digite o novo nome da obra: ");
            ...
            System.out.println("Escolha o tipo de obra desejada:");
            System.out.println("1. Pintura");
            System.out.println("2. Escultura");
            System.out.println("3. Fotografia");
            ...
            switch (tipoEscolha) {
                case 1:
                    ...
                    System.out.print("Digite a nova técnica usada na pintura: ");
                ...
                case 2:
                    ...
                    System.out.print("Digite o novo material usado na escultura: ");
                ...
                case 3:
                    ...
                    System.out.print("Digite o novo tipo de lente utilizada: ");
            ...
            System.out.println("Obra não encontrada, tente de novo");
        }
    }

    private static void excluirObraDeArte() {
        System.out.println("\n------ Excluir Obra de Arte ------");
        System.out.print("Digite o nome da obra a ser excluída: ");
        String titulo = Console.lerString();
    ...
    private static void buscaAvancada() {
        System.out.println("\n------ Busca Avançada ------");
        System.out.println("Escolha o critério de busca desejada:");
        ...
        switch (escolha) {
            ...
            case 3:
                ...
                break;
            default:
                System.out.println("Critérios de busca inválido.");
        }
    }
